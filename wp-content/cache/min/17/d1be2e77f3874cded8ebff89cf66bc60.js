...
jQuery(function (n) {
  ...
  0 < Cookies.get("woocommerce_items_in_cart")
    ...
    : n(".hide_cart_widget_if_empty").closest(".widget_shopping_cart").hide(),
  ...
  (b.prototype = {
    _init: function () {
      ...
      (this.phrases = []),
        ...
        a.each(
          this.element.html().split(this.settings.separator),
          function (c, d) {
...
jQuery(document).ready(function ($) {
  ...
  $(window).resize(function () {
    if (
      ...
      if (!noSticky) {
        main_navigation.css({ height: getNavHeight(), overflow: "auto" });
      }
    } else {
      main_navigation.removeAttr("style");
      main_navigation.removeClass("onepress-menu-mobile");
  ...
  if (onepress_js_settings.onepress_disable_animation != "1") {
    var wow = new WOW({ offset: 50, mobile: !1, live: !1 });
    wow.init();
  }
...
var Onepress_Bully = {
  ...
  disable_mobile: "",
  sections: {
    hero: { id: "hero", _id: "hero", inverse: 1, enable: !0, title: "Home" },
    features: {
      id: "features",
      _id: "features",
      inverse: !1,
...
(function ($) {
  ...
  var WPForms = {
    ...
    loadValidation: function () {
      if (typeof $.fn.validate !== "undefined") {
        ...
        $.validator.methods.email = function (value, element) {
          return (
            this.optional(element) ||
            /^[a-z0-9.!#$%&'*+\/=?^_`{|}~-]+@((?=[a-z0-9-]{1,63}\.)(xn--)?[a-z0-9]+(-[a-z0-9]+)*\.)+[a-z]{2,63}$/i.test(
              value
            )
          );
        };
            ...
            properties = {
              ...
              errorPlacement: function (error, element) {
                if (
                  ...
                  if (
                    element.parent().find("label.wpforms-error:visible")
                      .length === 0
                  ) {
              ...
              submitHandler: function (form) {
                ...
                if (
                  WPForms.empty($submit.get(0).recaptchaID) &&
                  $submit.get(0).recaptchaID !== 0
                ) {
                  if (altText) {
      ...
      if (typeof $.fn.timepicker !== "undefined") {
        $(".wpforms-timepicker").each(function () {
          ...
          if (
            ...
            properties = { scrollDefault: "now", forceRoundTime: !0 };
          }
    ...
    bindUIActions: function () {
      ...
      $(document).on(
        "change",
        ".wpforms-field-checkbox input, .wpforms-field-radio input, .wpforms-field-payment-multiple input",
        function () {
          var $this = $(this);
    ...
    pagebreakNav: function (el) {
      ...
      if (action === "next") {
        if (typeof $.fn.validate !== "undefined") {
          $page
            .find(
              "input.wpforms-field-required, select.wpforms-field-required, textarea.wpforms-field-required, .wpforms-field-required input"
            )
